...
class Main {
    public static final Map<String, Map<String, Object>> opts = [
            ...
            cn: [longOpt: 'create-nested-view', required: false, args: 0, argName: 'createNestedView', description: "Create Nested Parent View with name -n - gradle flag -DcreateNestedView=true - optional - must have Jenkins Nested View Plugin installed"],
